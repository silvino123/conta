    ...
    <?php include 'Slide-Menu.html'; ?>  
        <div id="page-wrapper" class="gray-bg">  
            <?php include 'Nav.html'; ?>  
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#gastos">Agregar Gastos</button>
                <br>
                <br>
                <div class="row">
                <div class="col-lg-12">
...
<div class="modal inmodal" id="gastos" tabindex="-1" role="dialog"  aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated fadeIn">
                                        ...
                                        <form class="form-horizontal" method="POST" action="RegistrarGasto.php">
                                            <div class="row">
                            ...
                            <div class="modal inmodal" id="EditarGasto" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                <div class="modal-content animated bounceInRight">
                                        ...
                                        <div class="modal-body">
                                        <form class="form-horizontal" method="post" action="EditarGastos.php">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $('#EditarGasto').on('show.bs.modal', function (e) {

                var rowid = $(e.relatedTarget).data('id');
                
                $.ajax({
                    type : 'post',
                    url : 'CargaModalGasto.php', 
